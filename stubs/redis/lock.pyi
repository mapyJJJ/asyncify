...
class Lock:
    ...
    local: _Local
    def __init__(self, redis: Redis[Any], name: str, timeout: float | None = ..., sleep: float = ..., blocking: bool = ..., blocking_timeout: float | None = ..., thread_local: bool = ...) -> None:
        ...
    ...
    def acquire(self, sleep: float | None = ..., blocking: bool | None = ..., blocking_timeout: float | None = ..., token: str | bytes | None = ...) -> bool:
        ...
