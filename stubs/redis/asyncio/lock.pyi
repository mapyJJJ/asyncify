...
class Lock:
    ...
    def __init__(self, redis: Redis[Any], name: str | bytes | memoryview, timeout: float | None = ..., sleep: float = ..., blocking: bool = ..., blocking_timeout: float | None = ..., thread_local: bool = ...) -> None:
        ...
    ...
    async def acquire(self, blocking: bool | None = ..., blocking_timeout: float | None = ..., token: str | bytes | None = ...) -> bool:
        ...
