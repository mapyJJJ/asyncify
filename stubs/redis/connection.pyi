...
class Connection:
    ...
    def __init__(self, host: str = ..., port: int = ..., db: int = ..., password: str | None = ..., socket_timeout: float | None = ..., socket_connect_timeout: float | None = ..., socket_keepalive: bool = ..., socket_keepalive_options: Mapping[str, int | str] | None = ..., socket_type: int = ..., retry_on_timeout: bool = ..., retry_on_error: list[type[Exception]] = ..., encoding: str = ..., encoding_errors: str = ..., decode_responses: bool = ..., parser_class: type[BaseParser] = ..., socket_read_size: int = ..., health_check_interval: int = ..., client_name: str | None = ..., username: str | None = ..., retry: Retry | None = ..., redis_connect_func: _ConnectFunc | None = ...) -> None:
        ...
...
class SSLConnection(Connection):
    ...
    def __init__(self, ssl_keyfile=..., ssl_certfile=..., ssl_cert_reqs=..., ssl_ca_certs=..., ssl_ca_data: Any | None = ..., ssl_check_hostname: bool = ..., ssl_ca_path: Any | None = ..., ssl_password: Any | None = ..., ssl_validate_ocsp: bool = ..., ssl_validate_ocsp_stapled: bool = ..., ssl_ocsp_context: Any | None = ..., ssl_ocsp_expected_cert: Any | None = ..., **kwargs) -> None:
        ...
...
class UnixDomainSocketConnection(Connection):
    path: str
    def __init__(self, path: str = ..., db: int = ..., username: str | None = ..., password: str | None = ..., socket_timeout: float | None = ..., encoding: str = ..., encoding_errors: str = ..., decode_responses: bool = ..., retry_on_timeout: bool = ..., retry_on_error: list[type[Exception]] = ..., parser_class: type[BaseParser] = ..., socket_read_size: int = ..., health_check_interval: int = ..., client_name: str | None = ..., retry: Retry | None = ..., redis_connect_func: _ConnectFunc | None = ...) -> None:
        ...
