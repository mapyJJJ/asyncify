...
class RedisCluster(AbstractRedisCluster, RedisClusterCommands[_StrType], Generic[_StrType]):
    ...
    def __init__(self, host: str | None = ..., port: int | None = ..., startup_nodes: list[ClusterNode] | None = ..., cluster_error_retry_attempts: int = ..., require_full_coverage: bool = ..., reinitialize_steps: int = ..., read_from_replicas: bool = ..., dynamic_startup_nodes: bool = ..., url: str | None = ..., **kwargs) -> None:
        ...
...
class NodesManager:
    ...
    def __init__(self, startup_nodes: Iterable[ClusterNode], from_url: bool = ..., require_full_coverage: bool = ..., lock: Lock | None = ..., dynamic_startup_nodes: bool = ..., **kwargs: Any) -> None:
        ...
