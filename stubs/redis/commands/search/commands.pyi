...
class SearchCommands:
    ...
    def create_index(self, fields, no_term_offsets: bool = ..., no_field_flags: bool = ..., stopwords: Any | None = ..., definition: Any | None = ..., max_text_fields: bool = ..., temporary: Any | None = ..., no_highlight: bool = ..., no_term_frequencies: bool = ..., skip_initial_scan: bool = ...):
        ...
    ...
    def add_document(self, doc_id, nosave: bool = ..., score: float = ..., payload: Any | None = ..., replace: bool = ..., partial: bool = ..., language: Any | None = ..., no_create: bool = ..., **fields):
        ...
    ...
    def profile(self, query: str | Query | AggregateRequest, limited: bool = ..., query_params: Mapping[str, str | float] | None = ...) -> tuple[Incomplete, Incomplete]:
        ...
