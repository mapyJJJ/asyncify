...
_AddressAndPort: TypeAlias = ...
_SentinelState: TypeAlias = ...
...
class Sentinel(SentinelCommands):
    ...
    def __init__(self, sentinels: Iterable[_AddressAndPort], min_other_sentinels: int = ..., sentinel_kwargs: dict[str, Any] | None = ..., **connection_kwargs) -> None:
        ...
